package com.valeriygulin.userfx;

import com.valeriygulin.userfx.controllers.ControllerData;
...
public class App extends Application {
    ...
    public static void main(String[] args) {
        /*try {
            Json2PojoGenerator generator = new Json2PojoGenerator("Source2.json", "src/main/java/");
            generator.generate("User", "com.valeriygulin.userfx.model");
        } catch (IOException e) {
